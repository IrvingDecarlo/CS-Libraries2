    ...
    public static void MainLoop(string input = ":>")
    {
      ...
      while (Looping)
      {
        ...
        try { Command.Run(str); }
          ...
          { ShowException(e.Message + ": " + e.InnerException.Message, e); }
        catch (CommandNotFoundException e)
          { ShowException(e.Message, e); }
        catch (Exception e)
          { ShowException("An unknown exception has occurred while executing the command: " + e.Message, e); }
      }
    }
