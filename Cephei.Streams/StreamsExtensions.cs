...
namespace Cephei.Streams
{
  ...
  public static class StreamsExtensions
  {
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadString(this BinaryReader reader, char[] buffer, int offset, int count, out int readbytes)
    {
      readbytes = reader.Read(buffer, offset, count);
      return new string(buffer, offset, readbytes);
    }
    ...
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by a SByte ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    /// <param name="buffer">Buffer for transferring data.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromSByte(this BinaryReader reader, char[] buffer)
      => reader.ReadStringFromSByte(buffer, 0, out _);
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by a SByte ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromSByte(this BinaryReader reader, char[] buffer, int offset, out int readbytes)
      => reader.ReadString(buffer, offset, reader.ReadSByte(), out readbytes);

    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by a byte ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    /// <param name="buffer">Buffer for transferring data.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromByte(this BinaryReader reader, char[] buffer)
      => reader.ReadStringFromByte(buffer, 0, out _);
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by a byte ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromByte(this BinaryReader reader, char[] buffer, int offset, out int readbytes)
      => reader.ReadString(buffer, offset, reader.ReadByte(), out readbytes);

    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an Int16 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    /// <param name="buffer">Buffer for transferring data.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromInt16(this BinaryReader reader, char[] buffer)
      => reader.ReadStringFromInt16(buffer, 0, out _);
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an Int16 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromInt16(this BinaryReader reader, char[] buffer, int offset, out int readbytes)
      => reader.ReadString(buffer, offset, reader.ReadInt16(), out readbytes);

    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an UInt16 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    /// <param name="buffer">Buffer for transferring data.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromUInt16(this BinaryReader reader, char[] buffer)
      => reader.ReadStringFromUInt16(buffer, 0, out _);
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an UInt16 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromUInt16(this BinaryReader reader, char[] buffer, int offset, out int readbytes)
      => reader.ReadString(buffer, offset, reader.ReadUInt16(), out readbytes);

    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an Int32 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    /// <param name="buffer">Buffer for transferring data.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromInt32(this BinaryReader reader, char[] buffer)
      => reader.ReadStringFromInt32(buffer, 0, out _);
    /// <summary>
    /// Reads data using a reader and returns a string. The number of characters to read will be defined by an Int32 ahead of the string.
    /// </summary>
    /// <param name="reader">Reader to use.</param>
    ...
    /// <param name="readbytes">Number of cases that were actually read.</param>
    /// <returns>The string that was read by the reader.</returns>
    public static string ReadStringFromInt32(this BinaryReader reader, char[] buffer, int offset, out int readbytes)
      => reader.ReadString(buffer, offset, reader.ReadInt32(), out readbytes);
