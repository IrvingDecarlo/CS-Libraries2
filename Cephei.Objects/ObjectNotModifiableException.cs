...
namespace Cephei.Objects
{
    ...
    /// </summary>
    public class ObjectNotModifiableException : ObjectException<IReadOnlyModifiable>
    {
        /// <summary>
        ...
        public ObjectNotModifiableException(IReadOnlyModifiable modif) : base(modif, "The object is not modifiable: '" + modif.ToString() + "'") { }
        ...
        public ObjectNotModifiableException(IReadOnlyModifiable modif, string message) : base(modif, message) { }
        ...
        public ObjectNotModifiableException(IReadOnlyModifiable modif, string message, Exception inner) : base(modif, message, inner) { }
    }
}
