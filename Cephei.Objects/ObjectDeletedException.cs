...
namespace Cephei.Objects
{
    ...
    /// </summary>
    public class ObjectDeletedException : ObjectException<IReadOnlyDeletable>
    {
        /// <summary>
        ...
        public ObjectDeletedException(IReadOnlyDeletable deletable) : base(deletable, "The object has already been deleted: '" + deletable.ToString() + "'") { }
        ...
        public ObjectDeletedException(IReadOnlyDeletable deletable, string message) : base(deletable, message) { }
        ...
        public ObjectDeletedException(IReadOnlyDeletable deletable, string message, Exception inner) : base(deletable, message, inner) { }
    }
}
