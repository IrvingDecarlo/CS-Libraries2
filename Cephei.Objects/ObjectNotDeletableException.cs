...
namespace Cephei.Objects
{
    ...
    /// </summary>
    public class ObjectNotDeletableException : ObjectException<IDeletable>
    {
        /// <summary>
        ...
        public ObjectNotDeletableException(IDeletable deletable) : base(deletable, "The object is not deletable: '" + deletable.ToString() + "'") { }
        ...
        public ObjectNotDeletableException(IDeletable deletable, string message) : base(deletable, message) { }
        ...
        public ObjectNotDeletableException(IDeletable deletable, string message, Exception inner) : base(deletable, message, inner) { }
    }
}
