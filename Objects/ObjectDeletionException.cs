...
namespace Cephei.Objects
{
    ...
    /// </summary>
    public class ObjectDeletionException : ObjectException<IDeletable>
    {
        /// <summary>
        ...
        public ObjectDeletionException(IDeletable deletable, Exception inner)
        ...
        /// <param name="inner">The inner exception.</param>
        public ObjectDeletionException(IDeletable deletable, string message, Exception inner) : base(deletable, message, inner) { }
    }
}
